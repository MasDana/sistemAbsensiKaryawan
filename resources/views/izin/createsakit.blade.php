        ...
        <div class="container">
            ...
            <div class="flex items-center justify-center w-full">
                <label for="file_input"
                    ...
                    <input type="file" id="file_input" name="file_input" class="hidden" accept="image/*" required />
                </label>
            </div>
            <div id="file_preview" class="mt-4 hidden">
                <img id="preview_img" src="#" alt="Preview" class="max-w-full h-auto" />
            </div>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Allowed file types: SVG, PNG,
