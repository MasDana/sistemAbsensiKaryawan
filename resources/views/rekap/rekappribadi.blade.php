    ...
    <div>
        ...
        <main class="flex-grow p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-xl text-left text-gray-700">Rekap Kehadiran Karyawan Secara Berkala</p>
            </div>
            <div class="flex flex-col gap-y-4 mt-4 mb-6">
                <form action="/presensi/laporanpribadi" method="POST" target="_blank" id="formLaporan"> @csrf
                    <!-- Bagian Dropdown -->
            ...
            formLaporan.addEventListener('submit', function(event) {
                ...
                if (!bulan || !tahun || !karyawan) {
                    Swal.fire({
                        icon: 'error', 
                        title: 'Gagal!',
                        text: 'Harap pilih semua field (bulan, tahun, karyawan) sebelum melanjutkan.',
                    });
