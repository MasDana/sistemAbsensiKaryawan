...
<section class="bg-gray-100 flex items-center justify-center bg-cover bg-center bg-no-repeat " style="background-image: url('{{ asset('gambar/bgloginblur.jpg') }}'); width: 100vw; height: 100vh; ">
    <div class="flex w-full max-w-4xl bg-white shadow-xl rounded-3xl">
        ...
        <div class="bg-white bg-opacity-80 p-8 w-full max-w-md flex items-center justify-center shadow-lg rounded-r-3xl">
            <form action="/sesi/loginadmin" method="POST" class="form w-full">
                @csrf
                ...
                <div class="input-box mb-4 relative">
                    ...
                    <!-- Input Field -->
                    <input type="email" id="email" value="{{ Session::get('email') }}" name="email" placeholder="Email" class="border border-gray-300 rounded-lg p-2 w-full @error('email') is-invalid @enderror">
                ...
                <div class="input-box mb-4 relative">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" placeholder="Password" class="border border-gray-300 rounded-lg p-2 w-full @error('password') is-invalid @enderror">
                        <img src="{{ asset('gambar/buka.png') }}" onclick="pass()" class="absolute right-3 top-1/2 transform -translate-y-1/2 h-8 w-8 cursor-pointer" id="pass-icon" alt="Toggle Password">
                    </div>
