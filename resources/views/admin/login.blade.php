...
@endif --}}
            ...
            style="background: linear-gradient(to right, #0000FF, #800080); width: 100vw; height: 100vh; background-size: cover; background-position: center; background-repeat: no-repeat;">
