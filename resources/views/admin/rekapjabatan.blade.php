...
<main class="flex-grow p-8 ">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <button id="btntambahjabatan" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-4 md:mb-0 md:mr-4">
            Tambah Data
        </button>
        <form action="/rekapjabatan" method="get" class="flex items-center">
            <input type="text" name="nama_jabatan" id="nama_jabatan" placeholder="Nama" value="{{ request('nama_jabatan') }}" class="border border-gray-300 p-2 rounded mr-2" />
        ...
        <div class="p-4 max-h-96 overflow-y-auto">
            <form action="{{ url('/store/jabatan-data') }}" method="POST" id="form-jabatan">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_jabatans" name="nama_jabatans" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md">
                </div>
            </form>
        </div>
