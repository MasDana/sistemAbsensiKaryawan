    ...
    <form action="#" class="space-y-4">
        ...
        <div class="px-80 mt-4">
            ...
            <select id="bulan" name="bulan"
                class="mt-1 block text-lg w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-center">
                <option value="">Bulan</option>
                @for ($i = 1; $i <= 12; $i++)
        ...
        <div class="px-80">
            ...
            <select id="tahun" name="tahun"
                class="mt-1 block text-lg w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-center mb-2">
        ...
        <div class="flex justify-center mt-4">
            <button type="button"
                class="bg-indigo-600 hover:bg-indigo-60 text-white font-semibold py-2 px-4 w-full 
    max-w-lg h-12 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                id="cari">
                Cari
            </button>
        </div>
    ...
    <footer class="fixed bottom-0 w-full bg-white shadow-md flex items-center px-0.5 py-0.5">
        <div class="grid grid-cols-5 gap-2 items-center justify-center w-full">
            ...
            <div class="item-menu text-center mt-3">
                <a href="#"
                    class="text-gray-700 hover:text-blue-500 h-5 w-10 flex items-center justify-center mx-auto">
