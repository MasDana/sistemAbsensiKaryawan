...
<body>
    <div class="body bg-gray-100 min-h-screen flex flex-col">
        ...
        <div class="card bg-white rounded-2xl shadow-2xl mt-10 mb-10 mx-28">
            ...
            <!-- Heading -->
            <h1 class="bg-indigo-700 px-6 py-4 text-xl font-bold text-center mb-4 rounded-t-xl text-white">Lakukan
                Absensi Anda</h1>
            ...
            <div class="flex p-8 items-center justify-center">
                @if ($cek > 0)
                    <button id="ambil_absen"
                        class="bg-indigo-600 text-l text-white px-4 py-3 rounded-lg hover:scale-105 transition-transform flex items-center">
