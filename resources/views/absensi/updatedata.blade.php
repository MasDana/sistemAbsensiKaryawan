            ...
            <form action="/karyawan/{{ $karyawan->id }}" method="post" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="no_hp" placeholder="No HP" value="{{ $karyawan->no_hp }}"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10">
                        <span class="absolute right-3 top-1/2 transform -translate-y-1/2 mt-3">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="alamat" placeholder="Alamat" value="{{ $karyawan->alamat }}"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10">
                    <span class="absolute right-3 top-1/2 transform -translate-y-1/2 mt-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="relative">
                        ...
                        <input type="text" name="email" placeholder="Email" value="{{ $karyawan->email }}"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10">
                    ...
                    <div class="relative mb-4">
                        ...
                        <input id="password" type="password" name="password" placeholder="Password"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10">
                        <!-- Tambahkan padding right untuk ruang ikon -->
                        <span id="togglePassword"
                            class="absolute right-4 top-1/2 transform -translate-y-1/6 cursor-pointer">
